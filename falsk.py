...
def process_user_input(user_input):
    ...
    # """
    history = f"历史记录{short_history} {long_history}"
    # 获取AI响应
...
def chat():
    ...
    if not user_input:
        response = json.dumps({'error': 'No input provided'}, ensure_ascii=False)
        return Response(response, mimetype='application/json; charset=utf-8'), 400
    ...
    try:
        ...
        return Response(response, mimetype='application/json; charset=utf-8'), 500
